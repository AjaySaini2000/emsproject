...
const Signin = () => {
    ...
    const handleSubmit =(e)=>{
        ...
        try{
            if(formdata.email==='SUPER_USER@gmail.com'){
    ...
    return (
        <div className="w-full h-[100vh] bg-[url('images/bgImage.png')] bg-cover bg-no-repeat bg-center">
                            ...
                            <div className="mt-5">
                                <form onSubmit={handleSubmit} method='post'>
                                    ...
                                    <div className='flex justify-center'>
                                        <button type="submit" className={`h-10 rounded-md text-white w-full ${isSubmitting ? 'bg-gray-400 cursor-not-allowed' : 'bg-dark-pink hover:bg-[#be1044] hover:text-lg'}`}
                                        >
                                            {isSubmitting ? (
