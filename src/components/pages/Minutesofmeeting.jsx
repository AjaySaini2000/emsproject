                        ...
                        <div className='mt-6'>
                            <div className='flex sm:flex-row flex-col justify-end sm:gap-4 gap-2'>
                                <div className='flex gap-4 sm:w-auto w-full '>
                                    ...
                                    <input type="text" name="price" id="price" className="block border-0 py-1.5 pl-7 text-gray-900 ring-1 ring-inset  placeholder:text-gray-400 focus:outline-none focus:shadow-md sm:text-sm sm:leading-6 w-full" placeholder="Search By Title" />
                                </div>
                                <div className="flex rounded-md z-0 sm:w-auto w-full sm:justify-start justify-end sm:order-last order-first ">
                                    <button type="button" className='bg-dark-pink text-white p-2 hover:bg-[#be1044] text-sm font-semibold'>ADD NEW TOPIC</button>
                                ...
                                <table className="min-w-full divide-y divide-gray-200 my-3 border border-gray-100">
                                    <thead className="bg-gray-50 ">
                                        <tr>
                                            ...
                                            <th scope="col" className="p-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider border border-gray-200">Meeting topic</th>
